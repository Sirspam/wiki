...
Benutzt du Linux, schau auf der [Linux Seite](./linux-modding.md) oder[Beataroni](https://github.com/geefr/beatsaber-linux-goodies/#readme) nach. :::
...
Check `#modding-announcements` in [BSMG](https://www.discord.gg/beatsabermods) to see if the latest version is moddable. Wenn dies nicht der Fall ist, kannst du diesen Tutorials folgen, um auf eine modifizierbare Version herunterzustufen.

Klick auf diese Links, wo du das Spiel gekauft hast, um die Tutorials zu sehen.
