...
## 照明効果の種類
使用可能な照明タイプは、ゲーム内ですべて一緒です。場所がわずかに異なるか、存在しないこともあります。

* **Center Lights:** トラックのそばや、下、マークとしてトラックの後ろにあったりします。 これは"Bottom/Back/Side"や"BBS" ライトと呼ばれます。
* **Side/Top Lasers:** プラットフォームによって左右や上下に位置する回転するレーザーライトです。 レーザーの回るスピードは制御できます。
* **Back Lasers:** トラックの後ろに多くは”X”の形で配置されているライトです。
...
::: warning 注意  
ライティングのプレビューは現在公開されているエディタで完全に再現されていません。ゲーム内で確認しましょう。 詳しくは[ライティングのプレビュー](#previewing-your-lights)をご覧ください。 :::
