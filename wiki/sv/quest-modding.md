...
:::warning Jag såg en video på YouTube, men jag fastnade/det fungerade inte. Varför? Vi på BSMG rekommenderar **starkt** emot att du använder någon video guide för modding. Ofta ser vi att dom är antingen, inaktuella, okomplet, innehåller felaktig information eller är helt felaktig.

Istället borde du följa dom skrivna guiderna här på wikin eller be om hjälp i [BSMGs Discord-server](https://discord.gg/beatsabermods). :::
...
:::warning Installing BMBF and modding your game will disable Official Multiplayer as well as viewing and uploading scores on the base game leaderboards. If you would like to play modded multiplayer, you need the mods, `Beat Together` and `MultiQuestensions`, which allows for cross-play between PC and Quest and for custom songs to be used. These mods should automatically be installed when setting up BMBF.
